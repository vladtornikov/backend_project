    ...
    data: UserRequestAdd = Body(
        openapi_examples={
            "1": {
                ...
                "value": {"email": "balesiy@mail.ru", "password": "123456789"},
            }
        }
    ),
):
...
@router.get("/me", summary="Получаем данные об аутентифицированном пользователе")
...
@router.get(
    "/logout", summary="Удаляем JWT-токен после того, как пользователь разлогинился"
)
